...
public class LevelEnd : MonoBehaviour
{
    ...
    public void rdest()
    {
        ...
        enemi = GameObject.FindGameObjectsWithTag("Enemy");
        foreach (var go in enemi)
        {
            Destroy(go);
        }
    ...
    public void RoomDestroy (Collider2D other)
    {
    ...
    void OnTriggerEnter2D(Collider2D other) { 
        ...
        PlayerPrefs.SetFloat("PlayerHealth", player.transform.GetComponent<PlayerHealth>().health);
    }
